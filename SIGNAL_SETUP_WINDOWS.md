...
signal-cli -u +61420309085 register

# Enter the code received via SMS
signal-cli -u +61420309085 verify CODE
```
...
```powershell
signal-cli -u +61420309085 send -m "HMAN is connected!" +61420309085
```
...
### Registration failed
- Ensure phone number is in E.164 format (+61420309085)
